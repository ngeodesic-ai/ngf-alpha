...
## Hardware Notes
Results validated on an NVIDIA A100 GPU (Colab Pro+). Testing on NVIDIA T4 and CPU currently inprogress. Performance may vary; A100 recommended for optimal results.
