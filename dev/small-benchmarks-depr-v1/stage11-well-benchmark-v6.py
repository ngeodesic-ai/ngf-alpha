...
python3 stage11-well-benchmark-v6.py --mode full --samples 50 --nperm 500 \
  --proto_width 160 --proto_widths 130,210 \
  --cfar_k 2.2 --cfar_guard 20 --cfar_bg 60 \
  --lambda0 0.25 --inhib_sigma 1.6 \
  --T0 2.6 --Tmin 0.7 --anneal_steps 5 --p_floor 0.12 \
  --sprt_tau 0.02 --drop_floor 0.006 \
  --pi \
  --dump_surfaces_dir dumps/v6_surfaces --dump_manifold dumps/v6_manifold.npz
